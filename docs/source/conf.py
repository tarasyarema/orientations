...
import sys
import six
project = u"Enumerating k-connected orientations"
copyright = u'2021, Taras Yarema'
package_name = 'orientations'
package_folder = "../../orientations"
authors = u"Taras Yarema."
...
templates_path = [os.path.join(
    SAGE_DOC_SRC, 'common', 'templates'), '_templates']
